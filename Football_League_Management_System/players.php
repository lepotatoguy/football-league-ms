...
<head>
  <title>Players | Bangladesh Football Premier League</title>
  <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        ...
        <?php
          $sql = "SELECT * FROM `player_info` ORDER BY `player_info`.`full_name` ASC";
          ...
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
            ...
            class="img-fluid" />';
              ...
              <div class="feature-1-content">
                ...
                <span class="position mb-3 d-block">Position: <?php echo $row['position1'] ?></span>    
                <p>Current Club: <?php echo $row['current_club'] ?></p>
                <p>Previous Club: <?php echo $row['prev_club'] ?></p>
                <p>Total Goals: <?php echo $row['total_goals'] ?></p>
              </div>
            </div>
          </div><?php } ?>
