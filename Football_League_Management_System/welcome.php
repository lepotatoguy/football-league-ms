...
<head>
  <title>Welcome &mdash; Bangladesh Football Premier League</title>
  <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lFg-3 text-right">
            <a href="#" class="small mr-3"><span class="icon-unlock-alt"></span> Welcome <?php echo $_SESSION['username']; ?> </a>
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    ...
                    <li><a href="about.html">Our Premier League</a></li>
                  </ul>
                </li>
                
                <li>
                  <a href="matches.html" class="nav-link text-left">Matches</a>
                </li>
                <li>
                  <a href="prev_matches.html" class="nav-link text-left">Previous Matches</a>
                </li>
                <li>
                    <a href="contact.html" class="nav-link text-left">Contact</a>
                  </li>
                  <li>
                    <a href="admissions.html" class="nav-link text-left">Dashboard</a>
                  </li>
              </ul>                                                                                                                                                                                                                                                                                          </ul>
            </nav>
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1>Biggest Premier League in Asia</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="intro-section" style="background-image: url('images/hero_2.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1>One of The Biggest Premier League in The World</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              <div class="icon-wrapper bg-primary">
                <span class="fas fa-users" style="color:#FFFFFF;"></span>
              </div>
              <div class="feature-1-content">
                <h2>World Class Players</h2>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Perspiciatis temporibus similique laboriosam libero obcaecati possimus! </p>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              <div class="icon-wrapper bg-primary">
                <span class="far fa-futbol" style="color:#FFFFFF;"></span>
              </div>
              <div class="feature-1-content">
                <h2>World Class Contest</h2>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Perspiciatis temporibus similique laboriosam libero obcaecati possimus! </p>
                <p><a href="#" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div> 
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              <div class="icon-wrapper bg-primary">
                <span class="fas fa-burn" style="color:#e0470a;"></span>
              </div>
              <div class="feature-1-content">
                <h2>One of The Most Competitive League</h2>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Perspiciatis temporibus possimus! </p>
                <p><a href="#" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div> 
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
            <!-- <span class="far fa-futbol fa-4x" style="color:#51BE78;"></span> -->
            <br><br>
            <a href=index.html><h3>BFPL Home</h3></a>
            <p></p>
          </div>
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
