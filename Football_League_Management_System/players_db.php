...
if(isset($_POST["delete"]) && !isset($_POST["delete"])==''){
  $id = $_POST["delete"];
  $sql3 = "DELETE FROM player_info WHERE id = '$id'";
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">BFPL</a>
...
<td> <form action="update_player.php" method="GET">
                                    <button class=" btn btn-success text-uppercase" type="submit" name="update"
                                        value="<?php echo $row['id']; ?>">update</button>
                                </form></td>
<td> <form action="" method="POST">
                                    <button class=" btn btn-danger text-uppercase" type="submit" name="delete"
